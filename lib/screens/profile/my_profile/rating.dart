      ...
      body: Form(
        ...
        child: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              children: [
                Text('Please rate your experience with this application.'.tr, style: styles.heading17),
                SizedBox(height: 20),
                RatingBar.builder(
                  initialRating: 5,
                  minRating: 1,
                ...
                TextFormField(
                  ...
                  decoration: styles.inputDecoration.copyWith(
                    ...
                    errorStyle: styles.errorStyleTicket,
                  ...
                  validator: (value) {
                    if (ratingSubmit < numStar && ratingDescription.isEmpty) {
                      return 'This field is mandatory if the rating is below @numStar star.'
                          .trParams({'numStar': numStar.toString()});
                    }
                    return null;
                  },
                  onChanged: (val) {

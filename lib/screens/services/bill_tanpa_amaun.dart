...
class BilTanpaAmaunServiceScreen extends StatelessWidget {
                          ...
                          .map(
                            (element) => Card(
                              ...
                              child: ExpansionTile(
                                  ...
                                  () => Checkbox(
                                    onChanged: (element.status == "Aktif")
                                        ? (value) {
                                            ...
                                            if (value) {
                                              controller.total.value += element.nettCalculations.total;
                                            } else {
                                              controller.total.value -= element.nettCalculations.total;
                                            }
                                          }
                                ...
                                subtitle: Text(
                                  dateFormatterDisplay.format(element.createdAt),
                                ),
                                ...
                                trailing: Row(
                                  ...
                                  children: [
                                    GestureDetector(
                                      ...
                                      child: Obx(
                                        () => element.isFavorite.value ? Icon(Icons.favorite) : Icon(Icons.favorite_outline),
                                      ),
                                    ),
                                    SizedBox(width: 10),
                                    GestureDetector(
                                      onTap: () => Get.to(() => BillDetailsScreen(), arguments: element),
                                ...
                                children: [
                                  ...
                                  element.billTypeId == 1
                                      ? VerticalDetail(
                                          ...
                                          detail: "RM " + moneyFormat(double.parse(element.nettCalculations.total.toString()))
                                        )
                                      : Padding(
                  ...
                  children: [
                    Expanded(
                      ...
                      child: AddToCartButton(
                        onPressed: () async => controller.addToCart(false),
                      ),
                    ),
                    SizedBox(width: 10),
                    Expanded(
                      ...
                      child: Obx(
                        () => PrimaryButton(
                          ...
                          text: "RM " + moneyFormat(double.parse(controller.total.toString())) + ' - ' + "Pay".tr,
                        ),
                      ),
                    ),
                  ],

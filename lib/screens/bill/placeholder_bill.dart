...
import 'package:flutterbase/screens/bill/bill_details.dart';
import 'package:flutterbase/screens/bill/checkout.dart';
import 'package:flutterbase/screens/bill/precart2_bil.dart';
import 'package:flutterbase/screens/bill/precheckout_bil.dart';
...
// import 'package:flutterbase/screens/cart/widgets/edit_amount_modal2.dart';
...
class _PlaceholderBillingScreenState extends State<PlaceholderBillingScreen> {
  ...
  bool cartable = true;
  List<model.Bill> billTypeOne = [];
  List<model.Bill> tempbillTypeOne = [];
  List<model.Bill> billTypeTwo = [];
  List<model.Bill> tempbillTypeTwo = [];
  List precart = [];
  List precart2 = [];
  List realcart = [];
  List realcart2 = [];

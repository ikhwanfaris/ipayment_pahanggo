...
import 'package:flutterbase/screens/content/profile/send_enquiry/add_enquiry.dart';
...
class _HomeEnquiryScreenState extends State<HomeEnquiryScreen> {
  ...
  void _getData() async {
    ...
    _enquiryModel2 = await api.getEnquiry(perPage);
    setState(() {
      ...
      bottomNavigationBar: BottomAppBar(
        child: Padding(
          ...
          child: PrimaryButton(
              text: 'New Enquiry'.tr,
              onPressed: () async {
                bool a = await navigate(context, AddEnquiryScreen());
                print(a);
                _getData();
              }),
        ),

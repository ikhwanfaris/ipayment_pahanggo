...
class _BillDetailsScreenState extends State<BillDetailsScreen> {
  late model.Bills _enquiryModel3;
  var inputFormat = DateFormat('dd-MM-yyyy');
  bool alreadySaved = false;
  // ignore: unused_field
  List<model.Bills> _enquiryModel4 = [];
  // ignore: unused_field
  List<model.Bills> _enquiryModel5 = [];
  // ignore: unused_field
  List<model.Bills> _enquiryModel8 = [];
  // ignore: unused_field
  List<model.Bills> _enquiryModel9 = [];
  // ignore: unused_field
  List<model.Bills> _enquiryModel10 = [];
  List<model.PaymentGateway> _enquiryModel6 = [];
  List<Bank> _enquiryModel7 = [];
  ...
  initApp() async {
    ...
    _enquiryModel7.removeWhere((item) => item.redirectUrls == null);
    ...
    for (var v = 0; v < _enquiryModel7.length; v++) {
      for (var q = 0; q < _enquiryModel7[v].redirectUrls!.length - 1; q++) {
    ...
    for (var v = 0; v < _enquiryModel7.length; v++) {
      for (var q = 0; q < _enquiryModel7[v].redirectUrls!.length; q++) {
        _enquiryModel11.add(
          Bank(
            active: true,
            ...
            name: _enquiryModel7[v].name +
                " " +
                (_enquiryModel7[v].redirectUrls![q].type.toString() == "RET"
                    ? "(Retail)"
                    : "(Corporate)"),
            redirectUrls: [
              RedirectUrl(
                  type: _enquiryModel7[v].redirectUrls![q].type,
                  url: _enquiryModel7[v].redirectUrls![q].url)
            ],
          ),
        );
      }
      ...
      appBar: AppBar(
        ...
        actions: [
          Padding(
            ...
            child: IconButton(
              icon: Icon(_enquiryModel3.favorite1 == 1 ||
                      // ignore: unrelated_type_equality_checks
                      _enquiryModel3.favorite == true
                  ? Icons.favorite
                  : Icons.favorite_border),
              color: Constants().primaryColor,
              onPressed: () async {
                await api.favABill(_enquiryModel3.id.toString());
                _enquiryModel3.favorite1 == 1
                    ? snack(
                                    ...
                                    child: ExpansionTile(
                                      ...
                                      children: [
                                        ...
                                        _enquiryModel3.nettCalculations!
                                            ...
                                            : Container(),
                                        // Amount Changes
                                        _enquiryModel3.amountChanges!.length !=
                                                0
                                            ? Align(
                                                alignment: Alignment.topLeft,
                                                child: Text(
                                                                  ...
                                                                  TypeAheadFormField(
                                                                      ...
                                                                      onSuggestionSelected:
                                                                        ...
                                                                        for (var v =
                                                                            ...
                                                                            v++) {
                                                                          for (var q = 0;
                                                                              q < _enquiryModel7[v].redirectUrls!.length;
                                                                              q++) {
                                                                            if (_enquiryModel7[v].name ==
                                                                                suggestion.toString()) {
                                                                              print("yes");
                                                                              print(_enquiryModel7[v].name);
                                                                              if (_enquiryModel7[v].redirectUrls![q].type.toString() == "RET") {
                                                                                ret.add(
                                                                                  Bank(
                                                                                    active: true,
                                                                                    code: _enquiryModel7[v].code,
                                                                                    name: _enquiryModel7[v].name,
                                                                                    redirectUrls: [
                                                                                      RedirectUrl(type: _enquiryModel7[v].redirectUrls![q].type, url: _enquiryModel7[v].redirectUrls![q].url)
                                                                                    ],
                                                                                  ),
                                                                                );
                                                                              }
                                                                              if (_enquiryModel7[v].redirectUrls![q].type.toString() == "COR") {
                                                                                cor.add(
                                                                                  Bank(
                                                                                    active: true,
                                                                                    code: _enquiryModel7[v].code,

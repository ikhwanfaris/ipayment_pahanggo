...
class PaymentWithoutBillSaleAnimalScreen extends StatefulWidget {
  ...
  @override
  State<PaymentWithoutBillSaleAnimalScreen> createState() => _PaymentWithoutBillSaleAnimalScreenState();
}
...
class _PaymentWithoutBillSaleAnimalScreenState extends State<PaymentWithoutBillSaleAnimalScreen> {
  @override
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Align(
                                              ...
                                              child: Text('Identification of medically important inserts', style: styles.heading10bold),
                                            ),
                                            SizedBox(height: 10),
                                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                              Flexible(flex: 2, child: Text('Mosquitoes')),
                                              Flexible(flex: 1, child: Text('RM ' + 150.toString())),
                                              Row(
                                                children: [
                                                  Column(
                                                    children: [
                                            ...
                                            Align(
                                              alignment: Alignment.centerLeft,
                                              child: Text('Mencit', style: styles.heading10bold),
                                            ),
                                            SizedBox(height: 10),
                                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                              Flexible(flex: 2, child: Text('Outbred (ICR mice)')),
                                              Flexible(flex: 1, child: Text('RM ' + 22.toString())),
                                              SizedBox(width: 10),
                                              Row(
                                                children: [
                                                  Column(
